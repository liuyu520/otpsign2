...
(function($) {
	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			var popup_message_html=$("#popup_message").text().replace(/\n/g, '<br />');
			var color_msg=null;
			if(type=='info'){
				color_msg="blue";
			}else{
			...
			$("#popup_message").html("<font color='"+color_msg+"' size='4' style='font-weight: bold' >"+popup_message_html+"</font>"  );
			$("#popup_message").addClass(type);
			//$("#popup_message").html("<img src= ></img>");
